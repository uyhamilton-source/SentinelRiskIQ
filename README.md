...
def main():
    ...
    if not st.session_state.logged_in:
        ...
        return
    header()
    st.info("This full package combines RiskNavigator reporting, SentinelRiskIQ branding, SOC 2 + HIPAA scoring, 2026 critical-control weighting, direct PDF exports, and client-friendly workbook upload.")
    with st.sidebar:
